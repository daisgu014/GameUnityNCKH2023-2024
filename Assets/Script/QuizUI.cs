...
public class QuizUI : MonoBehaviour
{
    ...
    [SerializeField] private GameObject gameOverPanel, mainMenu, gamePanel,chooseScreen;
    ...
    private void ChooseBtn(int index, string option)
    {
        ...
        manager.StartChoose(index, option);
    ...
    public void BackToChooseMenu()
    {
        ...
        SceneManager.LoadScene(mainMenu.scene.buildIndex);
        audioManager.playBtnAudio();
    }
